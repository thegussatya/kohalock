...
const RED_FLAG_DATA = [
  ...
  { month: 'Feb', anomalies: 15 },
  { month: 'Mar', anomalies: 8 },
  { month: 'Apr', anomalies: 10 },
  { month: 'Mei', anomalies: 5 },
  { month: 'Jun', anomalies: 3 },
];
      ...
      <div className="mt-8 bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
        ...
        <div className="w-full h-[300px]">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={RED_FLAG_DATA} margin={{ top: 5, right: 20, left: -20, bottom: 5 }}>
