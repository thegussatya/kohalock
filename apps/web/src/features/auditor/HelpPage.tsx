...
export default function HelpPage() {
  const faqItems = [
    { question: 'Bagaimana cara kerja Uji Alat Bukti (Integrity Checker)?', answer: 'Anda dapat mengunggah dokumen dari pihak eksternal, dan sistem akan membandingkan hash kriptografinya dengan data yang telah dikunci on-chain untuk mendeteksi rekayasa dokumen.' },
